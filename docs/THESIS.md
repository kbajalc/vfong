...
All ECG segments underwent these standard pre-processing steps proposed in previous studies [3].
...
The time-delayed method generates a shifted version of the original signal by delaying it for 0.5 seconds. So it is named time-delayed method [7]. Figure 2.7 is a demonstration of two phase space plots generated for normal sinus rhythm and VF with the time-delayed method.
